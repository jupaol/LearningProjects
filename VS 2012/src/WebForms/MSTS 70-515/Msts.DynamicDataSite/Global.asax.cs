using Msts.DynamicDataSite.DataAccess;
using System;
...
namespace Msts.DynamicDataSite
{
    public class Global : System.Web.HttpApplication
    {
        ...
        public static void RegisterRoutes(RouteCollection routes)
        {
            ...
            //DefaultModel.RegisterContext(typeof(pubsEntities), new ContextConfiguration() { ScaffoldAllTables = true });
            DefaultModel.RegisterContext(() => ((IObjectContextAdapter)new pubsEntities()).ObjectContext, new ContextConfiguration() { ScaffoldAllTables = true });
