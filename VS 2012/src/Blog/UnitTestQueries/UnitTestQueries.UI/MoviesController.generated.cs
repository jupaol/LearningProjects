...
namespace UnitTestQueries.UI.Controllers {
    public partial class MoviesController {
        ...
        public class ActionParamsClass_Index {
            public readonly string titleFilter = "titleFilter";
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_MoviesController: UnitTestQueries.UI.Controllers.MoviesController {
        public T4MVC_MoviesController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Index(string titleFilter) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Index);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "titleFilter", titleFilter);
            return callInfo;
        }
