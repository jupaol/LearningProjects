...
{
    public static MvcApplication4.Controllers.AccountController Account = new MvcApplication4.Controllers.T4MVC_AccountController();
    public static MvcApplication4.Controllers.Angular01Controller Angular01 = new MvcApplication4.Controllers.T4MVC_Angular01Controller();
    public static MvcApplication4.Controllers.HomeController Home = new MvcApplication4.Controllers.T4MVC_HomeController();
    public static BillManager.Web.Controllers.JasmineController Jasmine = new BillManager.Web.Controllers.T4MVC_JasmineController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class jasmine {
            private const string URLPATH = "~/Scripts/jasmine";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class jasmine_samples {
            private const string URLPATH = "~/Scripts/jasmine-samples";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            ...
            public static readonly string PlayerSpec_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/PlayerSpec.min.js") ? Url("PlayerSpec.min.js") : Url("PlayerSpec.js");
            public static readonly string Song_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Song.min.js") ? Url("Song.min.js") : Url("Song.js");
        ...
        public static readonly string ui_bootstrap_0_5_0_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ui-bootstrap-0.5.0.min.js") ? Url("ui-bootstrap-0.5.0.min.js") : Url("ui-bootstrap-0.5.0.js");
        public static readonly string ui_bootstrap_0_5_0_min_js = Url("ui-bootstrap-0.5.0.min.js");
        public static readonly string ui_bootstrap_tpls_0_5_0_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/ui-bootstrap-tpls-0.5.0.min.js") ? Url("ui-bootstrap-tpls-0.5.0.min.js") : Url("ui-bootstrap-tpls-0.5.0.js");
        public static readonly string ui_bootstrap_tpls_0_5_0_min_js = Url("ui-bootstrap-tpls-0.5.0.min.js");
    }
    ...
    public static class Content {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class jasmine {
            private const string URLPATH = "~/Content/jasmine";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
