...
namespace SportsStore.UI.Controllers {
    public partial class AccountController {
        ...
        public class ViewNames {
            public readonly string CurrentUser = "~/Views/Account/CurrentUser.cshtml";
            public readonly string Login = "~/Views/Account/Login.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AccountController: SportsStore.UI.Controllers.AccountController {
        ...
        public override System.Web.Mvc.ActionResult Login(SportsStore.UI.Models.LoginModel loginModel, string ReturnUrl) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Login);
        ...
        public override System.Web.Mvc.ActionResult CurrentUser() {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.CurrentUser);
            return callInfo;
        }
