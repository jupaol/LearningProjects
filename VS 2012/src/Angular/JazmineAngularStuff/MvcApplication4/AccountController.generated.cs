...
namespace MvcApplication4.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : MvcApplication4.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcApplication4.Models.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(MvcApplication4.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcApplication4.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(MvcApplication4.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcApplication4.Controllers.AccountController.ManageMessageId? message);

        public override System.Web.Mvc.ActionResult Manage(MvcApplication4.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcApplication4.Models.LocalPasswordModel model);

        public override System.Web.Mvc.ActionResult Manage(MvcApplication4.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MvcApplication4.Models.RegisterExternalLoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(MvcApplication4.Models.RegisterExternalLoginModel model, string returnUrl)
        {
