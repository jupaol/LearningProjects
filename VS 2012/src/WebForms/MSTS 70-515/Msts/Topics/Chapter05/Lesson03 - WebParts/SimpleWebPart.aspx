<%@ Page Title="" Language="C#" MasterPageFile="~/Topics/Chapter02/Lesson01 - MasterPages/ClassicMaster.Master" AutoEventWireup="true" CodeBehind="SimpleWebPart.aspx.cs" Inherits="Msts.Topics.Chapter05.Lesson03___WebParts.SimpleWebPart" %>

<%@ Register Src="~/Topics/Chapter05/Lesson03 - WebParts/UserControl1.ascx" TagPrefix="uc1" TagName="UserControl1" %>
<%@ Register Src="~/Topics/Chapter05/Lesson03 - WebParts/UserControl2.ascx" TagPrefix="uc1" TagName="UserControl2" %>
<%@ Register Src="~/Topics/Chapter05/Lesson03 - WebParts/UserControl3.ascx" TagPrefix="uc1" TagName="UserControl3" %>
