...
namespace SportsStore.UI.Areas.Administration.Controllers {
    public partial class AdminController {
        ...
        public class ViewNames {
            public readonly string Create = "~/Areas/Administration/Views/Admin/Create.cshtml";
            public readonly string Details = "~/Areas/Administration/Views/Admin/Details.cshtml";
            public readonly string Edit = "~/Areas/Administration/Views/Admin/Edit.cshtml";
            public readonly string List = "~/Areas/Administration/Views/Admin/List.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_AdminController: SportsStore.UI.Areas.Administration.Controllers.AdminController {
        ...
        public override System.Web.Mvc.ActionResult Edit(SportsStore.Domain.Entities.Product product, System.Web.HttpPostedFileBase image) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Edit);
        ...
        public override System.Web.Mvc.ActionResult Create(SportsStore.Domain.Entities.Product product) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.Create);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "product", product);
            return callInfo;
        }
