<%@ Page Title="" Language="C#" MasterPageFile="~/Topics/Chapter02 - Master - themes - caching/Lesson01 - MasterPages/ClassicMaster.Master" AutoEventWireup="true" CodeBehind="PartialOutputCaching.aspx.cs" Inherits="Msts.Topics.Chapter02.Lesson03.PartialOutputCaching" %>
<%@ OutputCache Duration="30" VaryByParam="*" %>
<%@ Register Src="~/Topics/Chapter02 - Master - themes - caching/Lesson03 - Caching/PartialCachedControl.ascx" TagPrefix="uc1" TagName="PartialCachedControl" %>
